...
// 	if err := tx.First(&existingUser, "user_id = ?", user.UserID).Error; err != nil {
// 		tx.Rollback()
// 		return nil, errors.Wrap(err, "authRepo.Update.First")
// 	}
...
// 	}).Error; err != nil {
// 		tx.Rollback()
// 		return nil, errors.Wrap(err, "authRepo.Update.Updates")
// 	}

// 	if err := tx.Commit().Error; err != nil {
// 		return nil, errors.Wrap(err, "authRepo.Update.Commit")
// 	}
